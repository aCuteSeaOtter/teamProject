        ...
        <div class="authentication-content">
          <div class="log-in">
            <div class="sign-in-form-wrap w-form">
              <form id="wf-form-Register-Email-Form" name="wf-form-Register-Email-Form" data-name="Register Email Form" method="get" class="sign-in-form" data-wf-page-id="6634a93befaafa41dc30c186" data-wf-element-id="e984411b-1169-0b63-3fe5-a77f0311b407">
                ...
                <div class="sign-in-single-fields">
                  ...
                  <div class="sign-in-single-field-wrap"><label for="Your-Confirm-Password" class="sign-in-field-label">Confirm Password</label><input class="sign-in-field w-input" maxlength="256" name="Your-Confirm-Password" data-name="Your Confirm Password" placeholder="**************" type="password" id="Your-Confirm-Password" required=""></div><input type="submit" data-wait="Please wait..." class="sign-in-submit-button w-button" value="Continue">
                </div>
              </form>
