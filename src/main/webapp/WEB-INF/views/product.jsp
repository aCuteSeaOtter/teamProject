                          ...
                          <div class="pages-dropdown-single-links-wrap">
                            ...
                            <div class="page-dropdown-list-flex-wrap">
                              ...
                              <div class="dropdown-list-wrapper">
                                ...
                                <a href="product.html" aria-current="page" class="dropdown-nav-link w-inline-block w--current">
                                  <div>Products</div>
                                </a>
          ...
          <div class="w-dyn-list">
            <div role="list" class="product-categories-flex-wrap w-dyn-items">
              <div role="listitem" class="product-categories-flex-wrap w-dyn-item">
                <a href="product.html" aria-current="page" class="product-categories-link w-inline-block w--current">
                  <div>All</div>
                </a>
            ...
            <div class="w-dyn-list">
              <div role="list" class="products-categories-flex-wrap w-dyn-items">
                <div role="listitem" class="products-categories-flex-wrap collection-item w-dyn-item">
                  <a href="product.html" aria-current="page" class="products-categories-link w-inline-block w--current">
                    <div>All</div>
                  </a>
          ...
          <div data-w-id="35101c2c-ff7c-f7b3-9aa9-ac2f2b9443b2" class="footer-links-wrapper">
            ...
            <div class="footer-links-flex-wrap">
              ...
              <div class="single-footer-links-flex-wrap">
                ...
                <a href="product.html" aria-current="page" class="single-footer-link w-inline-block w--current">
