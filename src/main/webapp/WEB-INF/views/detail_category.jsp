...
<html data-wf-page="6634a93befaafa41dc30c167" data-wf-site="6634a93aefaafa41dc30c070">
<head>
  <meta charset="utf-8">
  ...
  <link href="css/jiwons-dynamite-site-d2dd58.webflow.css" rel="stylesheet" type="text/css">
...
<body>
  <div class="pages-wrapper">
      ...
      <div class="container">
        <div class="navbar-wrapper">
          <div class="split-contant navbar-left">
            <a href="index.html" class="navbar-logo-wrap w-nav-brand"><img src="images/navbar-icon.svg" loading="lazy" alt="" class="navbar-logo"></a>
          </div>
          ...
          <div class="split-contant navbar-right">
            <div data-open-product="" data-wf-cart-type="leftSidebar" data-wf-cart-query="" data-wf-page-link-href-prefix="" class="w-commerce-commercecartwrapper" data-node-type="commerce-cart-wrapper">
              <a class="w-commerce-commercecartopenlink cart-button w-inline-block" role="button" aria-haspopup="dialog" aria-label="Open cart" data-node-type="commerce-cart-open-link" href="#"><img src="images/cart-Icon.svg" loading="lazy" alt="" class="cart-icon">
              ...
              <div style="display:none" class="w-commerce-commercecartcontainerwrapper w-commerce-commercecartcontainerwrapper--cartType-leftSidebar cart-wrapper" data-node-type="commerce-cart-container-wrapper">
                <div data-node-type="commerce-cart-container" role="dialog" class="w-commerce-commercecartcontainer cart-container">
                  <div class="w-commerce-commercecartheader cart-header">
                    ...
                    <a class="w-commerce-commercecartcloselink cart-close-button w-inline-block" role="button" aria-label="Close cart" data-node-type="commerce-cart-close-link"><img src="images/cart-close-icon.svg" loading="lazy" alt="" class="cart-close-icon"></a>
                  </div>
    ...
    <section class="section products">
      <div data-w-id="09ffd536-9315-8865-2dc1-af7f10ce06f0" style="opacity:0" class="products-contant-wrapper">
            ...
            <div class="w-dyn-list">
              <div role="list" class="products-categories-flex-wrap w-dyn-items">
                <div role="listitem" class="products-categories-flex-wrap w-dyn-item">
                  <a href="product.html" class="products-categories-link w-inline-block">
                    <div>All</div>
                  </a>
      ...
      <div class="container">
        <div class="footer-top">
          <div data-w-id="35101c2c-ff7c-f7b3-9aa9-ac2f2b9443a0" class="footer-details-wrap">
            <a href="index.html" class="footer-logo-wrap w-inline-block"><img src="images/footer-logo.svg" loading="lazy" alt="" class="footer-logo"></a>
