                        ...
                        <div class="pages-dropdown-flex">
                          ...
                          <div class="pages-dropdown-single-links-wrap">
                            ...
                            <div class="dropdown-list-wrapper">
                              ...
                              <a href="/teamProject/resources/utility-pages/license.html" class="dropdown-nav-link w-inline-block">
                                <div>License</div>
                              </a>
                              <a href="/teamProject/resources/utility-pages/style-guide.html" aria-current="page" class="dropdown-nav-link w-inline-block w--current">
                                <div>Style Guide</div>
                              </a>
      ...
      <div class="container">
        <div class="inner-banner-wrapper">
          ...
          <div class="breadcrumb-wrapper">
            ...
            <a href="/teamProject/resources/utility-pages/style-guide.html" aria-current="page" class="single-breadcrumb-link w-inline-block w--current">
              <div>Style Guide</div>
            </a>
          </div>
        </div>
      ...
      <div class="container">
        <div class="footer-top">
          ...
          <div data-w-id="35101c2c-ff7c-f7b3-9aa9-ac2f2b9443d9" class="footer-links-wrapper">
            ...
            <div class="footer-links-flex-wrap">
              <div class="single-footer-links-flex-wrap">
                <a href="/teamProject/resources/utility-pages/style-guide.html" aria-current="page" class="single-footer-link w-inline-block w--current">
                ...
                <a href="/teamProject/resources/utility-pages/license.html" class="single-footer-link w-inline-block">
        ...
        <div class="footer-bottom">
          <div data-w-id="35101c2c-ff7c-f7b3-9aa9-ac2f2b9443ee" class="footer-copyright-wrap">
            <div class="footer-copyright">© Copyright - <a href="/teamProject/resources/index.html" class="footer-source-link">Zastock</a> | Designed by <a href="https://www.flowzai.com/" target="_blank" class="footer-source-link">Flowzai </a>/ <a href="/teamProject/resources/utility-pages/license.html" class="footer-source-link">License</a> - Powered by <a href="https://webflow.com/" target="_blank" class="footer-source-link">Webflow</a>
            </div>
          </div>
